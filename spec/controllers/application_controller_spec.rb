...
RSpec.describe ApplicationController do
  ...
  context 'with a forgery' do
    ...
    it_behaves_like 'respond_with_error', 422
  end
  ...
  context 'with ActionController::RoutingError' do
    ...
    it_behaves_like 'respond_with_error', 404
  end
  ...
  describe 'forbidden' do
    ...
    it_behaves_like 'respond_with_error', 403
  end
  ...
  describe 'gone' do
    ...
    it_behaves_like 'respond_with_error', 410
  end
