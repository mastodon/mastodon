...
RSpec.describe BlockDomainService, type: :service do
  ...
  let!(:already_banned_account) { Fabricate(:account, username: 'badguy', domain: 'evil.org', suspended: true, suspended_at: 1.day.ago, silenced: true, silenced_at: 1.day.ago) }
