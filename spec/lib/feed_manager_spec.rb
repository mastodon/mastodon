    ...
    context 'for home feed' do
      ...
      context 'for irreversibly muted phrases' do
        it 'considers word boundaries when matching' do
          alice.custom_filters.create!(phrase: 'bob', context: %w(home), irreversible: true, keywords_attributes: [keyword: 'bob'])
          alice.follow!(jeff)
        ...
        it 'returns true if phrase is contained' do
          alice.custom_filters.create!(phrase: 'farts', context: %w(home public), irreversible: true, keywords_attributes: [keyword: 'farts'])
          alice.custom_filters.create!(phrase: 'pop tarts', context: %w(home), irreversible: true, keywords_attributes: [keyword: 'pop tarts'])
          alice.follow!(jeff)
        ...
        it 'matches substrings if whole_word is false' do
          alice.custom_filters.create!(phrase: 'take', context: %w(home), irreversible: true, keywords_attributes: [keyword: 'take', whole_word: false])
          alice.follow!(jeff)
