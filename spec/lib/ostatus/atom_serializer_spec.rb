...
RSpec.describe OStatus::AtomSerializer do
  ...
  describe '#entry' do
    ...
    it 'appends title element with status title' do
      ...
      entry = OStatus::AtomSerializer.new.entry(status.stream_entry)
      expect(entry.title.text).to eq 'username: Lorem ipsum dolor si'
    end
  ...
  describe '#feed' do
    ...
    it 'appends stream entries' do
      ...
      expect(feed.entry.title.text).to eq 'username: Lorem ipsum dolor si'
    end
  end
  ...
  describe '#object' do
    ...
    it 'appends title element with title' do
      ...
      expect(object.title.text).to eq 'username: Lorem ipsum dolor si'
    end
