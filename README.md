...
The project now includes a `Dockerfile` and a `docker-compose.yml`.
...
You will need to fill in, at least:
    ...
    Note: WOW Cable/Internet and Gmail SMTP hosts do not work.
...
Then you may login to your new Mastodon instance by browsing to http://(yourhost):3000/
