...
# Ruby image to use for base image, change with [--build-arg RUBY_VERSION="3.3.0"]
...
# Ruby image to use for base image based on combined variables (ex: 3.3.0-slim-bookworm)
