  ...
  class StatusesCLI < Thor
    ...
    def remove
      ...
      Status.remote
            ...
            .where('id NOT IN (SELECT statuses1.reblog_of_id FROM statuses AS statuses1 WHERE statuses.id = statuses1.reblog_of_id AND (statuses1.uri IS NULL OR statuses1.local))') # Skip statuses reblogged by local accounts
