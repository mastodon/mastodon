...
import SearchStatusContainer from '../features/compose/containers/search_status_container';
import LoadMore from './load_more';

class SearchStatusList extends React.PureComponent {
        ...
        <div className='scrollable' ref={this.setRef}>
          ...
          <div className='status-list'>
            ...
            {statusIds.map((statusId) => {
              return <SearchStatusContainer key={statusId} id={statusId} />;
            })}
...
SearchStatusList.defaultProps = {
  trackScroll: true
};

export default SearchStatusList;
