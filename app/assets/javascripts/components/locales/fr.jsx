const fr = {
  ...
  "onboarding.page_one.federation": "Mastodon est un réseau social qui appartient à tous et toutes.",
  ...
  "onboarding.page_four.home": "L'Acceuil affiche les posts de tous les utilisateurs⋅trices que vous suivez",
  "onboarding.page_four.notifications": "Les Notifications vous informent lorsque quelqu'un interagit avec vous",
  "onboarding.page_five.public_timelines": "Le fil public global affiche les posts de tous les utilisateurs⋅trices suivi⋅es par les membres de {domain}. Le fil public local est identique mais se limite aux utilisateurs⋅trices de {domain}.",
