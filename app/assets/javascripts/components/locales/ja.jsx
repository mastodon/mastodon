const ja = {
  ...
  "account.follow": "狩りごっこ",
  "account.followers": "フォロワー",
  "account.follows": "フォロー",
  "account.follows_you": "フォローされています",
  "account.mention": "おしゃべり",
  "account.mute": "ミュート",
  "account.posts": "がおー!",
  "account.report": "通報",
  ...
  "navigation_bar.community_timeline": "ますとどんちほー",
  "navigation_bar.edit_profile": "プロフィールを編集",
  "navigation_bar.favourites": "すごーい",
  ...
  "notification.reblog": "{name} さんがあなたのがおーを たーのしー しました",
  ...
  "status.reply": "おしゃべり",
  "status.replyAll": "全員とおしゃべり",
  "status.report": "通報",
  "status.sensitive_toggle": "クリックして表示",
  "status.sensitive_warning": "閲覧注意",
  "status.show_less": "隠す",
  "status.show_more": "もっと見る",
  "tabs_bar.compose": "がおー",
