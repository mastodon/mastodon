const es = {
  ...
  "account.requested": "Esperando para ser aprobado",
  ...
  "getting_started.open_source_notice": "Mastodon es una red social de código abierto. Puedes participar o reportar problemas en Github: {github}.",
  "column.home": "Inicio",
  ...
  "compose_form.private": "Privado",
  "compose_form.unlisted": "No mostrar en la timeline pública",
  ...
  "search.hashtag": "Etiqueta", // but maybe is better put Hashtag
  "upload_button.label": "Añadir fotos o videos",
  "upload_form.undo": "Deshacer",
  "notification.follow": "{name} te ha seguido",
  "notification.favourite": "{name} te ha dado favorito",
  "notification.reblog": "{name} volvió a publicar tu estado",
  "notification.mention": "{name} te ha mencionado",
  "notifications.column_settings.alert": "Notificaciones en el escritorio",
