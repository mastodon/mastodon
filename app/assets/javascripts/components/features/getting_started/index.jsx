    ...
    <Column icon='asterisk' heading={intl.formatMessage(messages.heading)}>
      ...
      <div className='scrollable optionally-scrollable' style={{ display: 'flex', flexDirection: 'column' }}>
        <div className='static-content getting-started'>
          <p><FormattedMessage id='getting_started.open_source_notice' defaultMessage='Mastodon is open source software. You can contribute or report issues on GitHub at {github}. {apps}.' values={{ github: <a href="https://github.com/tootsuite/mastodon" target="_blank">tootsuite/mastodon</a>, apps: <a href="https://github.com/tootsuite/mastodon/blob/master/docs/Using-Mastodon/Apps.md" target="_blank"><FormattedMessage id='getting_started.apps' defaultMessage='Various apps are available' /></a>, mastodonrussia: <a href="https://mastodonrussia.ru" target="_blank"><FormattedMessage id='getting_started.apps' defaultMessage='MastodonRussia' /></a> }} /></p>
        </div>
      </div>
    </Column>
  );
