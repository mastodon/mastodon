...
const PageOne = ({ acct, domain }) => (
  <div className='onboarding-modal__page onboarding-modal__page-one'>
    ...
    <div>
      ...
      <p><FormattedMessage id='onboarding.page_one.federation' defaultMessage='Mastodon is a network of independent servers (called instances) joining up to make one larger social network known as Fediverse.' /></p>
