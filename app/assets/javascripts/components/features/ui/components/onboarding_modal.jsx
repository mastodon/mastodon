...
const PageFour = ({ domain, intl }) => (
  <div className='onboarding-modal__page onboarding-modal__page-four'>
    <div className='onboarding-modal__page-four__columns'>
      ...
      <p><FormattedMessage id='onboarding.page_five.public_timelines' defaultMessage='The federated timeline lists public posts from everyone followed by people on {domain}. Local timeline is the same, but limited to people on {domain}.' values={{ domain }} /></p>
    </div>
  </div>
);
