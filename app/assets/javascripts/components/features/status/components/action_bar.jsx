...
<<<<<<< HEAD
        ...
        <div style={{ flex: '1 1 auto', textAlign: 'center' }}><IconButton animate={true} active={status.get('favourited')} title={intl.formatMessage(messages.favourite)} icon='cloud' onClick={this.handleFavouriteClick} activeStyle={{ color: '#9baec8' }} /></div>
