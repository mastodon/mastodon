...
class WebhookService < BaseService
  ...
  def serialize_event
    JSON.generate(ActiveModelSerializers::SerializableResource.new(@event, serializer: REST::Admin::WebhookEventSerializer, scope: nil, scope_name: :current_user).as_json)
  end
end
