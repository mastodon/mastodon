...
class PostStatusService < BaseService
  ...
  def post_to_crossbell
    ...
    request = Request.new(:post, ENV['CROSSBELL_WEBHOOK'], body: Oj.dump(ActiveModelSerializers::SerializableResource.new(@status, serializer: REST::StatusSerializer, scope: nil, scope_name: :current_user).as_json))
