...
export const expandPublicTimeline          = ({ maxId, onlyMedia, onlyRemote, onlyLocal } = {}, done = noOp) => expandTimeline(`public${onlyRemote ? ':remote' : ''}${onlyMedia ? ':media' : ''}${onlyLocal ? ':local' : ''}`, '/api/v1/timelines/public', { remote: !!onlyRemote, max_id: maxId, only_media: !!onlyMedia, local: !!onlyLocal }, done);
...
export const fillPublicTimelineGaps    = ({ onlyMedia, onlyRemote, onlyLocal } = {}, done = noOp) => fillTimelineGaps(`public${onlyRemote ? ':remote' : ''}${onlyMedia ? ':media' : ''}${onlyLocal ? ':local' : ''}`, '/api/v1/timelines/public', { remote: !!onlyRemote, only_media: !!onlyMedia, local: !!onlyLocal }, done);
