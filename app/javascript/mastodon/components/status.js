    ...
    if (featured) {
      prepend = (
        <div className='status__prepend'>
          <div className='status__prepend-icon-wrapper'><Icon className='fa fa-fw fa-thumb-tack status__prepend-icon' /></div>
      ...
      prepend = (
        <div className='status__prepend'>
          <div className='status__prepend-icon-wrapper'><Icon className='fa fa-fw fa-retweet status__prepend-icon' /></div>
