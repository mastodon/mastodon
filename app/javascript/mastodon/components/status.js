...
export default class Status extends ImmutablePureComponent {
  ...
  render () {
    ...
    return (
      <div className={`status ${this.props.muted ? 'muted' : ''} status-${status.get('visibility')} ${isMathjaxifyable(status.get('content')) !== null ? ' mathjaxified__content' : ''}`} data-id={status.get('id')}>
