  ...
  render () {
    ...
    return (
      <div className='status__action-bar'>
        ...
        <IconButton className='status__action-bar__button star-icon' animate active={status.get('favourited')} title={intl.formatMessage(messages.favourite)} icon='star' onClick={this.handleFavouriteClick} counter={(withCounters !== false) ? status.get('reblogs_count') : undefined} />
