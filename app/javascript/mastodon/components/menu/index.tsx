...
interface MenuProps {
  /**
   * Change the markup generated by the menu depending on its use case.
   * Ensure to use 'navigation' for menus that are primarily used for navigation.
   * Navigation menus don't support the `MenuItemRadio` and `MenuItemCheckbox` items.
   */
  type?: MenuType;
