...
const FrameWelcome = ({ domain, onNext }) => (
  <div className="introduction__frame">
    <div
      ...
      style={{
        background: `url(${logoTransparent}) no-repeat center center / auto 80%`,
      }}
    >
    ...
    <div className="introduction__text introduction__text--centered">
      ...
      <p>
        <FormattedMessage
          ...
          values={{ domain: <code>{domain}</code> }}
        />
      </p>
    </div>
    ...
    return (
      <div className="introduction">
        <ReactSwipeableViews
          ...
          className="introduction__pager"
        >
          {pages.map((page, i) => (
            <div
              key={i}
              className={classNames('introduction__frame-wrapper', {
        ...
        <div className="introduction__dots">
          {pages.map((_, i) => (
            <div
              ...
              className={classNames('introduction__dot', {
                active: i === currentIndex,
              })}
            />
          ))}
