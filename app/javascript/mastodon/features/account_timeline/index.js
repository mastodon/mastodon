...
const mapStateToProps = (
  state,
  { params: { accountId }, withReplies = false },
) => {
  ...
  return {
    ...
    featuredStatusIds: withReplies
      ? ImmutableList()
      : state.getIn(
          ['timelines', `account:${accountId}:pinned`, 'items'],
          emptyList,
        ),
...
class AccountTimeline extends ImmutablePureComponent {
  ...
  componentWillReceiveProps(nextProps) {
    if (
      ...
      this.props.dispatch(
        fetchAccountIdentityProofs(nextProps.params.accountId),
      );

      if (!nextProps.withReplies) {
        this.props.dispatch(
          expandAccountFeaturedTimeline(nextProps.params.accountId),
        );
      }

      this.props.dispatch(
        expandAccountTimeline(nextProps.params.accountId, {
  ...
  handleLoadMore = maxId => {
    this.props.dispatch(
      expandAccountTimeline(this.props.params.accountId, {
        maxId,
