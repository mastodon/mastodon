...
const WarningWrapper = ({ needsLockWarning, hashtagWarning, directMessageWarning }) => {
  ...
  if (hashtagWarning) {
    return <Warning message={<FormattedMessage id='compose_form.hashtag_warning' defaultMessage="This post won't be listed under any hashtag due to the currently selected visibility. Only public posts can be searched by hashtag." />} />;
  }
