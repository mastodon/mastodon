    ...
    return (
      <div className='compose-form__poll-wrapper'>
        ...
        <div className='poll__footer'>
          <button type='button' disabled={options.size >= 6} className='button button-secondary' onClick={this.handleAddOption}><Icon id='plus' /> <FormattedMessage {...messages.add_option} /></button>
