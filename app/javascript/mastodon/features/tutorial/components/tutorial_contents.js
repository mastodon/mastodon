  ...
  case 'welcome':
    return (
      <div className='tutorial-back-none'>
        <p className='tutorial-title'>ようこそknzk.meへ</p>
        <div className='tutorial-image knzk-logo' />
        <p className='tutorial-paragraph'>knzk.meは神崎おにぃさんが運営するマストドンです。</p>
        <p className='tutorial-paragraph'>その機能を実際に触りながら体験して見ましょう！</p>
        <p className='tutorial-footer'>MastodonはOSSです。<br />バグ報告や機能要望あるいは貢献を <a target='_blank' href='https://github.com/KnzkDev/mastodon'>こちら</a> から行なえます。</p>
      </div>
    );
  case 'ltl':
    return (
      <div className='tutorial-back-exist'>
        ...
        <p className='tutorial-paragraph'>knzk.me内の公開設定の投稿(トゥート)がすべて流れてきます。</p>
