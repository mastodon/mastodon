        ...
        <div className='scrollable about'>
          ...
          <Section title={intl.formatMessage(messages.aboutMastodon)}>
            <div className='prose'>
              ...
              <p><FormattedMessage id='about.mastodon.license' defaultMessage='Mastodon is free and open-source software, under the AGPLv3 licence. You can {download}.' values={{ download: <a href={source_url} target='_blank'><FormattedMessage id='about.mastodon.download' defaultMessage='download the source code' /></a>}} /></p>
