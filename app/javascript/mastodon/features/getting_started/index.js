...
import { me, invitesEnabled, playerEnabled, version } from '../../initial_state';
import { fetchFollowRequests } from '../../actions/accounts';
import { List as ImmutableList } from 'immutable';
import { Link } from 'react-router-dom';
import NavigationBar from '../compose/components/navigation_bar';
import ColumnPlayer from '../ui/components/column_player';
...
export default class GettingStarted extends ImmutablePureComponent {
  ...
  render () {
    ...
    navItems.push(
      ...
      ((playerEnabled) ? <ColumnPlayer key={i++} /> : <span />)
    );

    height += ((playerEnabled) ? (48 * 4) : (48 * 3));
    ...
    return (
      <Column>
        ...
        <div className='getting-started getting-started__footer'>
          <ul>
            <li><a href='https://bridge.joinmastodon.org/' target='_blank'><FormattedMessage
              id='getting_started.find_friends' defaultMessage='Find friends from Twitter'
            /></a> ·
            </li>
            ...
            {multiColumn && <li><Link to='/keyboard-shortcuts'><FormattedMessage
            ...
            <li><a href='https://github.com/tootsuite/documentation#documentation' target='_blank'><FormattedMessage
              id='getting_started.documentation' defaultMessage='Documentation'
            /></a> ·
            </li>
            <li><a href='/auth/sign_out' data-method='delete'><FormattedMessage
