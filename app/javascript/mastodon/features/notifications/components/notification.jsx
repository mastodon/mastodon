...
class Notification extends ImmutablePureComponent {
  ...
  renderAdminReport (notification, account, link) {
    ...
    const targetLink = <bdi><Link className='notification__display-name' data-hover-card={targetAccount.get('id')} to={`/@${targetAccount.get('acct')}`} dangerouslySetInnerHTML={targetDisplayNameHtml} /></bdi>;
  ...
  render () {
    ...
    const link             = <bdi><Link className='notification__display-name' href={`/@${account.get('acct')}`} data-hover-card={account.get('id')} to={`/@${account.get('acct')}`} dangerouslySetInnerHTML={displayNameHtml} /></bdi>;
