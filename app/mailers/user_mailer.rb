...
class UserMailer < Devise::Mailer
  CONVERTED = %w(confirmation_instructions reset_password_instructions password_change email_changed two_factor_disabled two_factor_enabled two_factor_recovery_codes_changed webauthn_enabled webauthn_disabled webauthn_credential_added webauthn_credential_deleted backup_ready appeal_approved appeal_rejected suspicious_sign_in).freeze
