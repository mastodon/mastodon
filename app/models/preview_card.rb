...
class PreviewCard < ApplicationRecord
  ...
  has_attached_file :image, processors: %i(thumbnail blurhash_transcoder), styles: ->(f) { image_styles(f) }, convert_options: { all: '-quality 90 +profile "!icc,*" +set modify-date +set create-date' }, validate_media_type: false
