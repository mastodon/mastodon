...
class Admin::ActionLogFilter
  ...
  ACTION_TYPE_MAP = {
    ...
    listable_tag: { target_type: 'Tag', listable: true }.freeze,
    memorialize_account: { target_type: 'Account', action: 'memorialize' }.freeze,
    not_listable_tag: { target_type: 'Tag', listable: false }.freeze,
    not_trendable_tag: { target_type: 'Tag', trendable: false }.freeze,
    not_usable_tag: { target_type: 'Tag', usable: false }.freeze,
    ...
    trendable_tag: { target_type: 'Tag', trendable: true }.freeze,
    ...
    usable_tag: { target_type: 'Tag', usable: true }.freeze,
