...
class Api::V1::Admin::EmailDomainBlocksController < Api::BaseController
  ...
  before_action -> { authorize_if_got_token! :'admin:read', :'admin:read:email_domain_blocks' }, only: %i(index show)
  before_action -> { authorize_if_got_token! :'admin:write', :'admin:write:email_domain_blocks' }, except: %i(index show)
