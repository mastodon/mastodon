...
class HomeController < ApplicationController
  ...
  def set_initial_state_json
    state = InitialStatePresenter.new(settings: Web::Setting.find_by(user: current_user)&.data || {},
                                      web_push_subscription: current_account.user.active_session.web_push_subscription.nil? ? nil : current_account.user.active_session.web_push_subscription.as_payload,
