...
class UserSettingsDecorator
  ...
  def process_update
    ...
    user.settings['mention_modal']       = mention_modal_preference if change?('setting_mention_modal')
  ...
  def mention_modal_preference
    boolean_cast_setting 'setting_mention_modal'
  end
