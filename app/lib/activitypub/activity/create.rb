...
class ActivityPub::Activity::Create < ActivityPub::Activity
  ...
  def process_status_params
    ...
    attachment_ids = process_attachments.take(Rails.configuration.x.max_attachments_per_status).map(&:id)
  ...
  def process_attachments
    ...
    as_array(@object['attachment']).each do |attachment|
      ...
      next if media_attachment_parser.remote_url.blank? || media_attachments.size >= Rails.configuration.x.max_attachments_per_status
