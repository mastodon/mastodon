...
what changes are desirable and what general processes to use. You should also read the project's [AI Policy] to understand how we approach AI-assisted contributions.
