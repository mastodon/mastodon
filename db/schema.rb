...
ActiveRecord::Schema.define(version: 20180310000000) do
  ...
  create_table "recently_used_tags", force: :cascade do |t|
  ...
  add_foreign_key "recently_used_tags", "accounts", on_update: :cascade, on_delete: :cascade
  add_foreign_key "recently_used_tags", "tags", primary_key: "name", on_update: :cascade, on_delete: :cascade
