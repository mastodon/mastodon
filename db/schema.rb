...
ActiveRecord::Schema.define(version: 20_221_206_114_142) do
  ...
  create_table 'account_domain_blocks', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.bigint 'account_id'
    t.index %w(account_id domain), name: 'index_account_domain_blocks_on_account_id_and_domain', unique: true
  end
  ...
  create_table 'account_notes', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w(account_id target_account_id), name: 'index_account_notes_on_account_id_and_target_account_id', unique: true
  ...
  create_table 'account_pins', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w(account_id target_account_id), name: 'index_account_pins_on_account_id_and_target_account_id', unique: true
  ...
  create_table 'account_stats', force: :cascade do |t|
    ...
    t.bigint 'tag_following_count', default: 0, null: false
  ...
  create_table 'accounts_tags', id: false, force: :cascade do |t|
    ...
    t.index %w(account_id tag_id), name: 'index_accounts_tags_on_account_id_and_tag_id'
    t.index %w(tag_id account_id), name: 'index_accounts_tags_on_tag_id_and_account_id', unique: true
  end
  ...
  create_table 'admin_action_logs', force: :cascade do |t|
    ...
    t.index %w(target_type target_id), name: 'index_admin_action_logs_on_target_type_and_target_id'
  end
  ...
  create_table 'announcement_mutes', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w(account_id announcement_id), name: 'index_announcement_mutes_on_account_id_and_announcement_id', unique: true
  ...
  create_table 'blocks', force: :cascade do |t|
    ...
    t.bigint 'target_account_id', null: false
    t.string 'uri'
    t.index %w(account_id target_account_id), name: 'index_blocks_on_account_id_and_target_account_id', unique: true
  ...
  create_table 'bookmarks', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w(account_id status_id), name: 'index_bookmarks_on_account_id_and_status_id', unique: true
  ...
  create_table 'conversation_mutes', force: :cascade do |t|
    ...
    t.bigint 'account_id', null: false
    t.index %w(account_id conversation_id), name: 'index_conversation_mutes_on_account_id_and_conversation_id', unique: true
  end
  ...
  create_table 'custom_emojis', force: :cascade do |t|
    ...
    t.index %w(shortcode domain), name: 'index_custom_emojis_on_shortcode_and_domain', unique: true
  end
  ...
  create_table 'favourites', force: :cascade do |t|
    ...
    t.bigint 'account_id', null: false
    t.bigint 'status_id', null: false
    t.index %w(account_id id), name: 'index_favourites_on_account_id_and_id'
    t.index %w(account_id status_id), name: 'index_favourites_on_account_id_and_status_id', unique: true
  ...
  create_table 'featured_tags', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.string 'name'
    t.index %w(account_id tag_id), name: 'index_featured_tags_on_account_id_and_tag_id', unique: true
  ...
  create_table 'follow_requests', force: :cascade do |t|
    ...
    t.index %w(account_id target_account_id), name: 'index_follow_requests_on_account_id_and_target_account_id', unique: true
  end
  ...
  create_table 'follows', force: :cascade do |t|
    ...
    t.boolean 'notify', default: false, null: false
    t.string 'languages', array: true
    t.index %w(account_id target_account_id), name: 'index_follows_on_account_id_and_target_account_id', unique: true
  ...
  create_table 'list_accounts', force: :cascade do |t|
    ...
    t.bigint 'account_id', null: false
    t.bigint 'follow_id'
    t.index %w(account_id list_id), name: 'index_list_accounts_on_account_id_and_list_id', unique: true
    t.index ['follow_id'], name: 'index_list_accounts_on_follow_id', where: '(follow_id IS NOT NULL)'
    t.index %w(list_id account_id), name: 'index_list_accounts_on_list_id_and_account_id'
  end
  ...
  create_table 'markers', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w(user_id timeline), name: 'index_markers_on_user_id_and_timeline', unique: true
  end
  ...
  create_table 'media_attachments', id: :bigint, default: -> { "timestamp_id('media_attachments'::text)" }, force: :cascade do |t|
    ...
    t.index %w(account_id status_id), name: 'index_media_attachments_on_account_id_and_status_id', order: { status_id: :desc }
  ...
  create_table 'mentions', force: :cascade do |t|
    ...
    t.index %w(account_id status_id), name: 'index_mentions_on_account_id_and_status_id', unique: true
  ...
  create_table 'mutes', force: :cascade do |t|
    ...
    t.bigint 'target_account_id', null: false
    t.datetime 'expires_at'
    t.index %w(account_id target_account_id), name: 'index_mutes_on_account_id_and_target_account_id', unique: true
  ...
  create_table 'notifications', force: :cascade do |t|
    ...
    t.index %w(activity_id activity_type), name: 'index_notifications_on_activity_id_and_activity_type'
  ...
  create_table 'pghero_space_stats', force: :cascade do |t|
    ...
    t.index %w(database captured_at), name: 'index_pghero_space_stats_on_database_and_captured_at'
  end
  ...
  create_table 'preview_cards_statuses', id: false, force: :cascade do |t|
    t.bigint 'preview_card_id', null: false
    t.bigint 'status_id', null: false
    t.index %w(status_id preview_card_id), name: 'index_preview_cards_statuses_on_status_id_and_preview_card_id'
  end
  ...
  create_table 'status_pins', force: :cascade do |t|
    ...
    t.index %w(account_id status_id), name: 'index_status_pins_on_account_id_and_status_id', unique: true
  ...
  create_table 'statuses', id: :bigint, default: -> { "timestamp_id('statuses'::text)" }, force: :cascade do |t|
    ...
    t.index %w(id account_id), name: 'index_statuses_local_20190824', order: { id: :desc }, where: '((local OR (uri IS NULL)) AND (deleted_at IS NULL) AND (visibility = 0) AND (reblog_of_id IS NULL) AND ((NOT reply) OR (in_reply_to_account_id = account_id)))'
    t.index %w(id account_id), name: 'index_statuses_public_20200119', order: { id: :desc }, where: '((deleted_at IS NULL) AND (visibility = 0) AND (reblog_of_id IS NULL) AND ((NOT reply) OR (in_reply_to_account_id = account_id)))'
    t.index ['in_reply_to_account_id'], name: 'index_statuses_on_in_reply_to_account_id', where: '(in_reply_to_account_id IS NOT NULL)'
    t.index ['in_reply_to_id'], name: 'index_statuses_on_in_reply_to_id', where: '(in_reply_to_id IS NOT NULL)'
    t.index %w(reblog_of_id account_id), name: 'index_statuses_on_reblog_of_id_and_account_id'
  ...
  create_table 'statuses_tags', id: false, force: :cascade do |t|
    ...
    t.index %w(tag_id status_id), name: 'index_statuses_tags_on_tag_id_and_status_id', unique: true
  end
  ...
  create_table 'tag_follows', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w(account_id tag_id), name: 'index_tag_follows_on_account_id_and_tag_id', unique: true
