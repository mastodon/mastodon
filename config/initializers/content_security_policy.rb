...
Rails.application.config.content_security_policy do |p|
  ...
  if Rails.env.development?
    ...
    p.connect_src :self, :data, :blob, assets_host, media_host, wasabi_host, Rails.configuration.x.streaming_api_base_url, *webpacker_urls
    p.script_src  :self, :unsafe_inline, :unsafe_eval, assets_host
  else
    p.connect_src :self, :data, :blob, assets_host, media_host, wasabi_host, Rails.configuration.x.streaming_api_base_url
