...
SimpleNavigation::Configuration.run do |navigation|
  ...
  navigation.items do |n|
    ...
    n.item :user_invites, safe_join([material_symbol('person_add'), t('invites.title')]), main_app.invites_path, if: -> { current_user.can?(:invite_users) && current_user.functional? && !self_destruct }
