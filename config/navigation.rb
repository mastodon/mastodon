...
SimpleNavigation::Configuration.run do |navigation|
  navigation.items do |n|
    ...
    n.item :admin, safe_join([fa_icon('cogs fw'), t('admin.title')]), admin_dashboard_url, if: proc { current_user.staff? } do |s|
      ...
      s.item :timeline_injection, safe_join([fa_icon('cogs fw'), t('admin.timeline_injection.title')]), edit_admin_timeline_injection_path, if: -> { current_user.admin? }, highlights_on: %r{/admin/timeline_injection}
